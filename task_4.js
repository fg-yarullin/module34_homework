function Device(name, power, voltage) {
    this.name = name,
    this.power = power;
...
Device.prototype.plugIn_unplug = function() {
    this.isPluggedIn = this.isPluggedIn ? false : true;
    return this.isPluggedIn;
}

Device.prototype.getSpecificationsList = function() {
    let str = '';
...
Device.prototype.logInfo = function() {
...
Device.prototype.turn_On_Off = function() {
